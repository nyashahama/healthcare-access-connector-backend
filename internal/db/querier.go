...
type Querier interface {
	...
	DeleteSystemAdminByUserID(ctx context.Context, userID pgtype.UUID) error
	...
	SearchSystemAdmins(ctx context.Context, arg SearchSystemAdminsParams) ([]SystemAdmin, error)
